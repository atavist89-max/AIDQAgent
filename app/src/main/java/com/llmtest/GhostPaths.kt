...
object GhostPaths {
    ...
    // GaaS governance files (Fast GaaS)
    val GaaSPolicies = File(DQ_STATE_DIR, "gaas_policies.json")
    val StationPrompts = File(DQ_STATE_DIR, "station_prompts.json")
    val GaaSBlock = File(DQ_STATE_DIR, "gaas_block.json")
